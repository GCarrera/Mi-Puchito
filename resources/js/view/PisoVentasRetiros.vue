				...
				<div class="card">
					<div class="card-body">
						<div style="font-size: 1em;" class="mt-3">
							<h1 class="text-center font-italic">Retiros de {{dataPiso}}</h1>

							<div class="mt-3">
								<div class="card shadow">
									<div class="card-body">
										<h4 class="text-center">Retiros</h4>
										<tableRetiros :id="dataRetiros"/>
									</div>
								</div>
							</div>
...
<script>
	import tableRetiros from '../components/TableRetiros';
	...
	export default{
		...
		data(){
			return{
				dataRetiros: this.$attrs.dataretiros,
