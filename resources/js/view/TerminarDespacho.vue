	...
	<div>
		<div class="container">
			<div class="card shadow">
				<div class="card-body">
					<h1 class="text-center">Editar Despacho</h1>
					<div class="mb-3">
              ...
              <div class="form-row">
                <div class="form-group col-md-3">
                  ...
                  <select class="form-control" disabled>
                    <option selected>{{ this.nombrepiso }}</option>
                  </select>
                </div>
    ...
    components: {
      ...
      agregar_producto_enter(){
        ...
        console.log("get_datos");
				...
				axios.get('/api/despachos-datos-edit/'+this.dataId).then(response => {
          ...
          this.nombrepiso = this.despacho.piso_venta.nombre;
          this.idpv = this.despacho.piso_venta_id;
          ...
          this.despacho.productos.forEach(item => {

            console.log("forEach");

            let resultado = this.inventario.find(element => element.id == item.pivot.inventory_id)
            this.articulo.nombre = resultado.product_name;
            this.articulo.modelo = resultado;
            this.articulo.id = resultado.id;
            this.articulo.cantidad = item.pivot.cantidad;
        ...
        //console.log(this.productos);
				...
				axios.post('/api/despachos-edit', {productos: this.productos, id: this.dataId, guardar: this.guardar, idpv: this.idpv}).then(response => {
