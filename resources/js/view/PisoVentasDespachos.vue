				...
				<div class="card">
					<div class="card-body">
						<div style="font-size: 1em;" class="mt-3">
							<h1 class="text-center font-italic">Despachos de {{dataPiso}}</h1>

							<div class="mt-3">
								<div class="card shadow">
									<div class="card-body">
										<h4 class="text-center">Despachos</h4>
										<tableDespachos :id="dataDespachos"/>
									</div>
								</div>
							</div>
...
<script>
	...
	export default{
		...
		data(){
			return{
				dataDespachos: this.$attrs.datadespachos,
